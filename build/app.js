...
(function () {
  ...
  function updateElement() {
    ...
    if (options.email && options.gravatar) {
      var get_gravatar = function get_gravatar(email, size) {
        ...
        var emailLower = options.email.toLowerCase();

        var emailResult = md5(emailLower);
    ...
    if (options.email) {
      element.innerHTML += "<a class=\"email\" href=\"mailto:" + options.email + "\"></a><padding></padding>";
    }
    if (options.twitter) {
      element.innerHTML += "<a class=\"twitter\" href=\"https://www.twitter.com/" + options.twitter + "\"></a><padding></padding>";
    }
    if (options.facebook) {
